...
/*
 * 右侧边栏 recycle view 适配器
 */
public class EndSliderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    public Context mContext;
    public List<String> str;

    public EndSliderAdapter(Context mContext, List<String> str) {
